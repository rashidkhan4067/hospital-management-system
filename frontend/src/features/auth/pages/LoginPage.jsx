...
/**
 * 🔓 LoginPage - Google Enterprise 'Sign-in' Archetype
...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-white md:bg-[#F8F9FA] flex flex-col items-center justify-center p-4 md:p-6">
      <motion.div 
        ...
        <Card variant="outlined" className="p-8 md:p-12 flex flex-col items-center bg-white shadow-none md:shadow-sm">
          ...
          <div className="flex flex-col items-center gap-4 mb-8">
             ...
             <div className="flex flex-col items-center gap-1.5 mt-4">
                <h1 className="text-2xl font-semibold text-[#202124] tracking-tight text-center leading-tight">Sign in</h1>
                <p className="text-sm text-[#3C4043] font-medium text-center">to continue to Health Intelligence Hub</p>
             </div>
          </div>

          {/* 📟 Intelligence Port (Form) */}
