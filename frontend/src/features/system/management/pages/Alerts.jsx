...
import ConfigMatrix from '@/features/system/management/components/ConfigMatrix';
import PropagationHistory from '@/features/system/management/components/PropagationHistory';
...
export default function Alerts() {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8 animate-in fade-in duration-700 p-4 md:p-6 pb-20">
      ...
      <PropagationHistory alerts={alerts} />
    </div>
  );
}
