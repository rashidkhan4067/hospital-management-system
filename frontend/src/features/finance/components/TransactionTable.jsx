            ...
            cell: (t) => (
                <TableActions 
                    ...
                    actions={[
                        ...
                        { label: 'Export Data', icon: Download, onClick: () => onAction?.('export', t) },
                        { label: 'Print Receipt', icon: Printer, onClick: () => onAction?.('print', t) },
                        { label: 'Audit Log', icon: FileText, onClick: () => onAction?.('audit', t) },
                    ]}
                />
            )
        },
