 ...
 * High-fidelity confirmation portal for permanent identity deletion.
 */
        ...
        >
            <div className="flex flex-col items-center text-center space-y-8 py-6">
                ...
                <div className="space-y-3">
                    <h3 className="text-xl font-black text-slate-900 dark:text-white uppercase tracking-tighter">Confirm Kernel Wipe?</h3>
                ...
                <div className="w-full flex flex-col gap-4 pt-4">
                    <Button
                        ...
                        className="w-full bg-rose-500 text-white p-5 rounded-2xl text-[10px] font-black uppercase tracking-[0.3em] shadow-xl shadow-rose-500/30 hover:brightness-110 active:scale-95 transition-all flex items-center justify-center gap-3 border-none"
                    >
                        {isSubmitting ? <><Zap size={16} className="animate-spin" /> Purging Shard...</> : <><Trash2 size={16} /> Terminate Record</>}
                    </Button>
                    <Button
                        onClick={onClose}
                        className="w-full bg-transparent text-slate-400 p-4 rounded-xl text-[9px] font-black uppercase tracking-widest hover:bg-slate-100 dark:hover:bg-white/5 transition-all border-none"
                    >
                        Abort Protocol
                    </Button>
                </div>
