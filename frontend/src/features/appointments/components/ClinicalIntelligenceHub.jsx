...
const ClinicalIntelligenceHub = () => {
   return (
      <Card className="p-6 lg:p-8 rounded-[2.5rem] bg-white/70 dark:bg-slate-900/10 backdrop-blur-3xl border border-slate-200 dark:border-white/5 shadow-2als relative overflow-hidden flex flex-col gap-8 group">
         ...
         <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 relative z-10">
            <div className="flex items-center gap-3 sm:gap-4 overflow-hidden">
               ...
               <div className="flex flex-col min-w-0">
                  <h3 className="text-lg sm:text-xl lg:text-3xl font-black text-slate-900 dark:text-white italic uppercase tracking-tighter leading-none truncate">Throughput Intelligence</h3>
                  <p className="text-[8px] sm:text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em] mt-1.5 opacity-60">Velocity Real-time Matrix</p>
               </div>
            </div>

            <div className="flex items-center gap-4 sm:gap-6 shrink-0">
               <div className="flex flex-col text-right">
                  <p className="text-[8px] sm:text-[9px] font-black text-slate-400 uppercase tracking-widest leading-none">Avg. Waiting Time</p>
                  <div className="flex items-center justify-end gap-2 mt-1.5">
                     <span className="text-xl sm:text-2xl font-black text-slate-900 dark:text-white tabular-nums italic tracking-tighter uppercase leading-none">18.4</span>
         ...
         <div className="w-full h-48 sm:h-64 lg:h-72 relative z-10 mt-2 sm:mt-4 px-1">
            ...
            {[
               ...
               <div key={idx} className={`flex flex-col gap-2 ${idx === 2 ? 'sm:col-span-2 lg:col-span-1' : ''}`}>
                  <div className="flex items-center gap-2">
                     ...
                     <span className="text-[8px] sm:text-[9px] font-black text-slate-400 uppercase tracking-widest">{stat.label}</span>
                  </div>
