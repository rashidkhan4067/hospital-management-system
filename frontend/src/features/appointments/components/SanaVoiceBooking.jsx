 ...
 * Focused on high-density interaction.
 */
const SanaVoiceBooking = ({ onStart }) => {
   return (
      <Card className="p-5 lg:p-6 rounded-[2.5rem] bg-slate-950 border border-accent-primary/20 shadow-2als relative overflow-hidden flex flex-col gap-6 group">
         ...
         <div className="flex items-center justify-between relative z-10 shrink-0">
            <div className="flex items-center gap-3">
               ...
               <div className="flex flex-col">
                  <h3 className="text-lg lg:text-xl font-black text-indigo-100 italic uppercase tracking-tighter leading-none">Talk to Sana</h3>
                  <p className="text-[9px] font-bold text-accent-primary/50 uppercase tracking-[0.2em] mt-1">Neural Booking Hub</p>
               </div>
            </div>
         ...
         <button 
            onClick={onStart}
            className="w-full py-4 rounded-2xl bg-accent-primary hover:bg-accent-primary/90 text-[10px] font-black uppercase text-white tracking-widest flex items-center justify-center gap-3 shadow-xl shadow-accent-primary/25 border-none transition-all group-hover:scale-[1.02]"
         >
         ...
         <div className="flex items-center justify-center gap-4 relative z-10 opacity-30">
            <div className="flex flex-col items-center">
               <span className="text-[9px] font-black text-slate-400 italic">Confidence</span>
               <span className="text-[10px] font-black text-white italic tracking-tighter tabular-nums mt-0.5 uppercase">98.4%</span>
            </div>
            <div className="w-[1px] h-4 bg-white/10" />
            <div className="flex flex-col items-center">
               <span className="text-[9px] font-black text-slate-400 italic">Latency</span>
...
export default SanaVoiceBooking;
