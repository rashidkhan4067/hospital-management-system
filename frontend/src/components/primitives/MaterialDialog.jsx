      ...
      {isOpen && (
        <div className="fixed inset-0 z-[1000] flex items-center justify-center p-4 sm:p-6">
          ...
          <motion.div
            ...
            transition={{ duration: 0.3, ease: M3_EASING }}
            className="relative w-full sm:max-w-[500px] bg-surface-bright rounded-[20px] shadow-2xl overflow-hidden flex flex-col max-h-[90vh] transition-colors duration-300 border border-outline-variant/30"
          >
            {/* Header */}
