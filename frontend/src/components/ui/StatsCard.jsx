 ...
 */
export default function StatsCard({ title, value, icon: Icon, color = 'var(--accent-primary)', trend, onClick }) {
  ...
  // 🛡️ Robust Icon Resolution Logic (Supports Elements, Components, and ForwardRefs)
