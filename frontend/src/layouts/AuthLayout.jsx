...
const AuthLayout = () => {
  return (
    <div className="min-h-screen shifaa-portal-bg flex flex-col items-center justify-center selection:bg-[#E8F0FE] font-['Inter',sans-serif]">
      {/* 
          🎯 Responsive Card Constraint
          Mobile: Full width, full height, no border
          Desktop (sm+): 448px, 28px radius, bordered card
      */}
      <main className="w-full h-full sm:h-auto sm:max-w-[448px] bg-white border-none sm:border-[#DADCE0] sm:border-[1px] rounded-none sm:rounded-[28px] p-6 sm:p-10 flex flex-col justify-center animate-in fade-in duration-500 overflow-hidden relative shadow-sm">
        <Outlet />
      </main>
