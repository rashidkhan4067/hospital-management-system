...
import { ShieldCheck, Lock, EyeOff, UserCheck, HardDrive, Key, ChevronRight, Activity, Bell } from 'lucide-react';
 ...
 * Updated: Blue Color Consistency Edition
 */
export default function SafetyPage() {
  ...
  const protocols = [
    { 
       ...
       desc: "Every voice consultation and message is encrypted at the source using AES-256 GCM logic, ensuring only you and your specialist have clear-text access."
    },
    { 
       icon: <UserCheck size={24} />, 
       label: "Identity Verification", 
       title: "Verified Practitioner Network", 
       desc: "All specialists in the Al Shifaa hub undergo 3nd-party PMDC verification before being granted access to diagnostic agents and patient nodes."
    },
    { 
       icon: <HardDrive size={24} />, 
       label: "Storage Security", 
       title: "Atomic Decentralized Vaults", 
       desc: "Patient files are stored in isolated clinical vaults with Zero-Knowledge encryption, meaning even our sysadmins cannot view your health data."
    },
    { 
       icon: <EyeOff size={24} />, 
       label: "Anonymity Layer", 
       title: "AI Anonymization Units", 
       desc: "Medical records used for diagnostic research are automatically stripped of PII (Personally Identifiable Information) via our internal AI cleaning pipeline."
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-32 lg:py-56 bg-[#fbfbfd] border-t border-slate-100 overflow-hidden relative">
         <div className="container mx-auto px-6 max-w-7xl">
                ...
                <div className="lg:w-1/2 space-y-12">
                   <div className="space-y-6">
                      ...
                      <p className="text-xl lg:text-2xl text-[#86868b] leading-relaxed font-medium">
                         Al Shifaa implements a "Zero Trust" security model. This means every request to our clinical servers is verified based on identity, context, and time-bound encryption tokens.
                      </p>
                   </div>
                ...
                <div className="lg:w-1/2 relative">
                    <div className="w-full aspect-square bg-[#1d1d1f] rounded-[64px] shadow-2xl flex items-center justify-center p-12 lg:p-20 relative overflow-hidden group">
                        ...
                        <div className="absolute bottom-12 left-12 right-12 p-8 bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl z-20">
                           <p className="text-[10px] font-black uppercase tracking-widest text-white/40 mb-2">Internal Real-time Pulse Monitor</p>
