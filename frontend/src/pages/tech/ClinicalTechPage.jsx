...
import { Cpu, Zap, Activity, ShieldCheck, Database, Globe, Microscope, Binary, Waves, Boxes, Cpu as Brain } from 'lucide-react';
 ...
 * Design: High-Fidelity Minimalist.
 * Focus: Elimination of lag and a redesigned "Engineering Trust" obsidian hub.
 */
export default function ClinicalTechPage() {
  ...
  const features = [
    { 
       ...
       desc: "Al Shifaa specialists utilize real-time agentic research nodes for high-precision diagnostic analysis and expert peer-review."
    },
    { 
       icon: <Binary size={28} />, 
       label: "Clinical Tubes", 
       title: "Unified Shard Network", 
       desc: "Connecting Pakistani medical nodes to global clinical protocols via high-integrity, low-latency secure streaming."
    },
    { 
       icon: <Database size={28} />, 
       label: "Atomic Consistency", 
       title: "Immutable Health Ledger", 
       desc: "Medical records are managed using atomic locking protocols, ensuring absolute data integrity and zero-conflict history."
    },
    { 
       icon: <Microscope size={28} />, 
       label: "Precision Unit", 
       title: "Live Consult Stream", 
       desc: "Integrated biometric data-flow providing specialists with immediate diagnostic telemetry during every voice consultation."
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-48 pb-20 lg:pt-56 lg:pb-32 relative overflow-hidden bg-white">
        {/* Simplified Background Gradient (No Lag) */}
          ...
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-16">
            ...
            >
                <div className="flex items-center gap-4">
                    ...
                    <span className="text-[#86868b] text-[10px] font-black uppercase tracking-widest hidden sm:block">Diagnostic Hub Active</span>
                </div>
            ...
            {/* Performance Optimized Status Widget */}
      ...
      <section className="py-24 lg:py-56 bg-[#1d1d1f] text-white relative overflow-hidden rounded-[40px] lg:rounded-[64px] mx-4 lg:mx-8 mb-20 shadow-2xl">
         {/* Minimal High-Tech Accents */}
