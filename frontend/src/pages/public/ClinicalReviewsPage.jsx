...
import { Star, Quote, Heart, ShieldCheck, Activity, User, MessageCircle } from 'lucide-react';
...
export default function ClinicalReviewsPage() {
  ...
  const reviews = [
    { 
       ...
       desc: "The precision of the AI diagnostic agent paired with Dr. Ahmed's expertise was life-saving."
    },
    { 
       ...
       desc: "I was skeptical about AI-augmented healthcare, but the Al Shifaa portal made booking so easy."
    },
    { 
       ...
       desc: "Having my medical data atomic and synced across all units made my recovery journey much smoother."
    },
    { 
       author: "Fatima Noor", 
       ...
       desc: "The peace of mind knowing my child's data is end-to-end encrypted is everything."
    }
  ];
  ...
  return (
    <PageContainer 
      ...
      description="Our impact is measured not just in numbers, but in the recovery and trust of thousands of patients."
      maxWidth="full"
      className="bg-white p-0!"
    >
      <SEO 
        title="Patient Feedback Hub" 
        description="Real stories and measured excellence from the Al Shifaa clinical network." 
      />
      {/* 🌟 Reviews Hero Section */}
      <section className="pt-32 pb-20 lg:pt-48 lg:pb-32 relative overflow-hidden bg-white text-center">
        ...
        <div className="container mx-auto px-6 max-w-4xl relative z-10">
          ...
          >
            <div className="space-y-6">
                ...
                <p className="text-xl lg:text-3xl text-[#1d1d1f] font-medium leading-relaxed max-w-3xl pt-6 mx-auto">
                    Our impact is measured not just in numbers, but in the recovery and trust of thousands of patients.
                </p>
                ...
                {reviews.map((r, i) => (
                    ...
                    >
                        ...
                        <div className="space-y-6 relative z-10">
                            ...
                            <p className="text-lg lg:text-xl text-[#86868b] leading-relaxed font-medium italic">
                                "{r.desc}"
                            </p>
                        </div>
                        ...
                        <div className="h-40 w-full flex items-end gap-2 overflow-hidden">
                            {[40, 70, 45, 90, 65, 80, 55, 95, 75, 85].map((h, i) => (
                                <motion.div 
                                    ...
                                    className="flex-1 bg-[#007aff]/30 rounded-t-xl hover:bg-[#007aff] transition-colors"
                                ></motion.div>
                            ))}
                        </div>
