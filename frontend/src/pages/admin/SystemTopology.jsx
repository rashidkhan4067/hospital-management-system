...
export default function SystemTopology() {
  const sections = [
    ...
    { title: 'Clinical Database', icon: <Database />, color: 'indigo', status: '99.9%', description: 'Schema version 4.2.1-stable. All shards synchronized.' },
    { title: 'AI Neural Core', icon: <Zap />, color: 'amber', status: 'Optimized', description: 'Sana AI node processing at 122ms latency level.' },
    { title: 'Global Cloud Relay', icon: <Cloud />, color: 'blue', status: 'Stable', description: 'Regional endpoints active. CDN propagation active.' },
  ];
