...
import { Search, Globe2, ArrowLeft, ChevronRight, Activity, ShieldCheck, Zap, Filter } from 'lucide-react';
 ...
 * Optimized for mobile touch and high-fidelity visuals.
 */
export default function DoctorsPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-48 pb-20 lg:pt-56 lg:pb-24 relative overflow-hidden bg-white">
        ...
        <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-blue-50/30 blur-[100px] lg:hidden -z-10"></div>
      ...
      <div className="sticky top-[70px] lg:top-[80px] z-[50] w-full px-4 md:px-6">
        <div className="container mx-auto max-w-7xl">
            ...
            >
                ...
                {/* Refined Filter Container (Hide Ugly Scroll) */}
      ...
      {/* 🧬 Specialists Directory Grid (High Density) */}
      <section className="py-24 lg:py-48 bg-white min-h-[600px]">
        <div className="container mx-auto px-4 lg:px-6 max-w-7xl">
            <AnimatePresence mode='popLayout'>
                {loading ? (
                    ...
                    <div className="py-48 text-center bg-[#fcfdfe] rounded-[48px] border border-dashed border-slate-200">
                         <h3 className="text-3xl font-black text-[#1d1d1f] mb-4">No Units Found</h3>
                         <p className="text-[#86868b] font-medium max-w-md mx-auto px-6">We currently do not have a specialist matching these parameters in the Al Shifaa system.</p>
                         <Button 
                             onClick={() => {setActiveFilter('all'); setSearchQuery('');}}
                             className="mt-12 bg-[#1d1d1f] text-white rounded-2xl px-12 h-16 font-black uppercase tracking-widest text-[10px] shadow-xl"
                         >
