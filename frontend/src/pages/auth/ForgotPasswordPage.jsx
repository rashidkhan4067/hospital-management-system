...
import { Mail, ArrowLeft, Send, Sparkles, CheckCircle, Heart, ShieldCheck, Activity, ArrowRight } from 'lucide-react';
...
/**
 * 🔑 ForgotPasswordPage - Sleek Horizontal Split Hub (V6)
 * Design: Unified Horizontal Profile consistent with Login/Register.
 */
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center p-4 lg:p-10 bg-[#f8f9fc] selection:bg-[#007aff] selection:text-white">
      ...
      <motion.div 
        ...
        className="w-full max-w-[1150px] lg:h-[650px] bg-white rounded-[40px] shadow-[0_80px_160px_-40px_rgba(0,0,0,0.12)] overflow-hidden flex flex-col lg:flex-row border border-slate-50/50"
      >
          ...
          {/* 📄 Auth Section */}
          <div className="lg:w-[60%] bg-white p-8 lg:p-14 flex flex-col justify-center">
                  ...
                  {isSent ? (
                    <div className="space-y-8 animate-in zoom-in-95 duration-500 text-center lg:text-left">
                        ...
                        <div className="space-y-4">
                           <h3 className="text-3xl font-black text-[#1d1d1f] tracking-tighter italic uppercase">Check Inbox.</h3>
